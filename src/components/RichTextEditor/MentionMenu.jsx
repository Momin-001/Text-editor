...
export const MentionMenu = forwardRef(
  (
    ...
    return (
      <div
        ref={ref}
        className="fixed z-50 bg-white border border-gray-200 rounded w-80 max-h-96 flex flex-col"
        style={{
          top: position.top,
          left: position.left,
        }}
      >
        ...
        >
          <Tabs.List className="flex border-b border-gray-200">
            <Tabs.Trigger
              value="users"
              className="flex-1 px-3 py-2 text-xs font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50 data-[state=active]:text-blue-700 data-[state=active]:border-b-2 data-[state=active]:border-blue-700 transition-colors"
            >
              ...
              <div className="space-y-1">
                {filteredUsers.map((user, index) => (
                  <div
                    ...
                    className={`px-3 py-2 rounded cursor-pointer flex items-center gap-3 transition-colors ${
